...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'uses' => 'تعداد قابل استفاده برای کاربر',
        'total_uses' => 'تعداد قابل استفاده',
        'clicks_count' => 'تعداد کلیک',
        'duration' => 'مدت زمان',
        'item_id' => 'آیتم',
        'active_discount_percentage' => 'تخفیف فعال',
        'marketable' => 'قابل فروش',
        'customizable' => 'قابل شخصی سازی',
        'guarantee_id' => 'گارانتی',
        'guarantee_duration' => 'اعتبار گارانتی',
        'guarantee_description' => 'توضیحات گارانتی',
        'color_code' => 'کد رنگ',
        'review_subjects' => 'عناوین دیدگاه',
        'owners' => 'مالکان',
        'items' => 'آیتم ها',
        'rewards' => 'پاداش ها',
        'counts' => 'تعداد',
        'condition' => 'شرط ها',
        'order' => 'ترتیب',
        'target_id' => 'آیتم مرتبط',
        'attribute_id' => 'ویژگی',
        'display_mode' => 'نوع نمایش',
        'score_impact' => 'ضریب تاثیر',
        'price_from' => 'بازه شروع قیمت',
        'price_to' => 'بازه پایان قیمت',
    ],
];
